    ...
    <>
      ...
      <div className="space-y-8">
        {Array.from({ length: totalWeeks }, (_, w) => {
          ...
          const title = modules.find((m) => m.module.week === week)?.module.title;
          return (
            <section key={week}>
              <div className="mb-3 flex items-baseline gap-3">
                ...
                {week === currentWeek && <Label>Current</Label>}
              </div>
                  ...
                  const row = (
                    <>
                      <span className="w-28 shrink-0 font-mono text-xs text-muted">
                        {formatWeekday(i.startsAt).slice(0, 3)} {formatShortDate(i.startsAt)}
                      </span>
